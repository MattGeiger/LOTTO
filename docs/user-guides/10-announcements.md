...
2. Find the **Announcement** card and type in **Live Preview**, using the
   toolbar for titles, bold, italics, and lists. To type Markdown directly,
   switch to **Edit Code** and see
   [Markdown Formatting](09-markdown-formatting.md).
...
- Formatting syntax: [Markdown Formatting](09-markdown-formatting.md).
