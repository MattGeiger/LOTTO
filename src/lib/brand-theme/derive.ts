...
const deriveLight = (
  ...
  return {
    ...
    "nav-active-background": formatOklch(withAlpha(primary, 0.12)),
...
const deriveDark = (
  ...
  return {
    ...
    "nav-active-background": formatOklch(withAlpha(primary, 0.18)),
...
const deriveHiVizLight = (
  ...
  return {
    ...
    "nav-active-background": formatOklch(withAlpha(hiVizPrimary, 0.2)),
...
const deriveHiVizDark = (
  ...
  return {
    ...
    "nav-active-background": formatOklch(withAlpha(hiVizGlow, 0.25)),
