...
// Pixel-art gamepad glyph (arcade nav: "Games"). Geometry from
// src/arcade/lucid_icons/SVG/Flat/gaming.svg; fill set to currentColor.
export function GamingIcon(props: ComponentPropsWithoutRef<"svg">) {
  return (
    <svg
