...
/**
 * Client-side highlighter for a help guide. Reads the `?q=` search term from the
 * URL, wraps matches inside the rendered guide article in <mark> tags, and
 * scrolls the deep-linked section (URL hash) into view. Ported from FEED's
 * HighlightOnArrival; the only change is reading `q` from `useSearchParams`
 * (next/navigation) instead of a prop.
 */
