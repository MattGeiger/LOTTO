...
- Replaced `/new` language onboarding morph-cycle text with static copy and disabled shared display-language morphing for the personalized `/new` board to prevent idle/poll-triggered text motion.
